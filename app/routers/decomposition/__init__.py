...
from app.routers.decomposition.confirm import router as confirm_router
from app.routers.decomposition.lock import router as lock_router
...
decomposition_router.include_router(confirm_router, prefix="/plans", tags=["Confirm"])
...
decomposition_router.include_router(lock_router, prefix="/plans", tags=["Plan Lock"])
